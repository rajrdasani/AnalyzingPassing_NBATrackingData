...
```{r}
all_ball_above10 <- all_ball_frames[all_ball_frames$radius > 10,]
...
all_ball_new = merge(all_ball_above10, all_ball_frames, 
      by = colnames(all_ball_frames), 
      all = TRUE)
...
```{r}
strsplit(as.character(all_shot_starts$game_clock[1]), ":")[[1]][2]
